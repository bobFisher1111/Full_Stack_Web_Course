...
app.get("/", function(req, res){
  // inside quotation marks, is pointing to views.home page
  res.render("home", { 
    startingContent: homeStartingContent,
    posts: posts // passing in the post array
  }); 
});

app.get("/about", function(req, res){
  // inside quotation marks, is pointing to views.about page
  res.render("about", {
...
app.get("/contact", function(req, res){
  // inside quotation marks, is pointing to views.contact page
  res.render("contact", {
...
app.get("/compose", function(req, res){
  // inside quotation marks, is pointing to views.compose page
  res.render("compose"); 
});
...
app.post("/compose", function(req, res){
  ...
  // taking json post and adding it to global array posts
  posts.push(post);
